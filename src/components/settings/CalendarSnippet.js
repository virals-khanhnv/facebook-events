        ...
        <Page fullWidth>
            <Layout>
                <Layout.Section>
                    ...
                    <p className="howto">You can put code <code>&lt;div class="ot-facebook-events-calendar"&gt;&lt;/div&gt;</code> where you want to show calendar</p>
                    <div className="form-group">
                    ...
                    <p className="howto">The page with <code>&lt;div class="ot-facebook-events"&gt;&lt;/div&gt;</code> can show event when you click a date in calendar.</p>
