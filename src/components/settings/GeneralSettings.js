            ...
            <Layout>
                <Layout.Section>
                    ...
                    <div className="form-group">
                      <label className="my-1 mr-2" for="inlineFormCustomSelectPref">View Mode <span className='important_input'>*</span></label>
                    ...
                    <div className="form-group">
                      ...
                      <input type="text" className="form-control" id="pageName" placeholder="Facebook Events 1" />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <input type="number" className="form-control" id="event-limit" />
                    </div>
                    <div className="form-group">
                      <label className="my-1 mr-2" for="inlineFormCustomSelectPref">Ordering Events <span className='important_input'>*</span></label>
                      <select className="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref">
                    ...
                    <div className="form-group">
                      <label className="my-1 mr-2" for="inlineFormCustomSelectPref">Show Event date</label>
                      <select className="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref">
                    ...
                    <div className="form-group">
                      ...
                      <input type="text" className="form-control" id="seeAllEvents" />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <input type="text" className="form-control" id="seeAllEvents" placeholder="readmore" />
                    </div>
                    <div className="form-group">
                      <div className="colorpicker">
                        <label className='mr-3' for="section1backgroundColor">Readmore background color :</label>
                        <input type="color" id="section1backgroundColor" onInput={(e) => handleChangeColorBackground(e)} name="head" value={valueColorBackground} />
                      </div>
                      <div className="colorpicker">
                        <label className='mr-3' for="section1ParagraphColor">Readmore text color :</label>
                        <input type="color" id="section1ParagraphColor" onInput={(e) => handleChangeColorText(e)} name="head" value={valueColorText}  />
                      </div>
                    </div>
